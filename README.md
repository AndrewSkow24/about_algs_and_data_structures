...
|  #  |  Название алгоритма   |         Язык реализации         |
| :-: | :-------------------: | :-----------------------------: |
|  1  |    Линейный поиск     | [js](ex_004.js) [py](ex_004.py) |
|  2  |    Бинарный поиск     | [js](ex_005.js) [py](ex_005.py) |
|  3  | Рекурсивный факториал | [js](ex_006.js) [py](ex_006.py) |
